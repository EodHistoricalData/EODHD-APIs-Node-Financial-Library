...
async function main() {
  ...
  await test('historicalMarketCap', () => client.historicalMarketCap('AAPL.US', { from: '2025-01-01', to: '2025-01-10' }));
  ...
  await test('exchanges.symbolChangeHistory', () => client.exchanges.symbolChangeHistory({ from: '2025-01-01', to: '2025-01-31' }));
  ...
  await test('cboe.index', () => client.cboe.index({ 'filter[index_code]': 'BUK100P', 'filter[feed_type]': 'eod', 'filter[date]': '2025-01-15' }));
  ...
  console.log('\nMarketplace — Unicorn Bay:');
  await test('unicornbay.options.contracts', () => client.marketplace.unicornbay.options.contracts({ 'filter[underlying_symbol]': 'AAPL', 'page[limit]': 3 }));
  await test('unicornbay.options.eod', () => client.marketplace.unicornbay.options.eod({ 'filter[underlying_symbol]': 'AAPL', 'page[limit]': 3 }));
  await test('unicornbay.options.underlyingSymbols', () => client.marketplace.unicornbay.options.underlyingSymbols({ 'page[limit]': 3 }));
  ...
  await test('unicornbay.tickdata', () => client.marketplace.unicornbay.tickdata('AAPL', { from: '1740000000', to: '1740001000' }));
  ...
  await test('praams.reportEquityByTicker', () => client.marketplace.praams.reportEquityByTicker('AAPL.US', { email: 'test@example.com' }));
