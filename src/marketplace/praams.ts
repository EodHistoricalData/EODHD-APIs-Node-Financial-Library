...
import type { Ticker, PraamsExploreParams, PraamsExploreEquityBody, PraamsExploreBondBody } from '../types.js';
...
export class PraamsApi {
  ...
  async analyseEquityByTicker(ticker: Ticker): Promise<unknown> {
  ...
  async bankIncomeStatementByTicker(ticker: Ticker): Promise<unknown> {
  ...
  async bankIncomeStatementByIsin(isin: string): Promise<unknown> {
  ...
  async bankBalanceSheetByTicker(ticker: Ticker): Promise<unknown> {
  ...
  async bankBalanceSheetByIsin(isin: string): Promise<unknown> {
  ...
  async exploreEquity(params: PraamsExploreParams = {}, body: PraamsExploreEquityBody = {}): Promise<unknown> {
    return this.http.post('/mp/praams/explore/equity', params, body);
  }

  /** Smart bond screener: POST /mp/praams/explore/bond */
  async exploreBond(params: PraamsExploreParams = {}, body: PraamsExploreBondBody = {}): Promise<unknown> {
